...
public class OPC
{
  ...
  void draw()
  {
    ...
    for (int i = 0; i < numPixels; i++) {
      ...
      packetData[ledAddress + 2] = (byte)0x0F; //some static white
      packetData[ledAddress + 3] = (byte)pixel; //white and green are still switched

      ledAddress += 4;

      if (enableShowLocations) {
        pixels[pixelLocation] = 0xFFFFFFFF ^ pixel;
      }
    }
