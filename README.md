...
To do: ~~Support RGBW color orders, Fix processing sketches/add at least one example~~ Check timing for SK6812 led's, they have a different timing then the WS281x
